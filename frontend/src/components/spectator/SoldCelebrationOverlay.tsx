    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-2xl">
        <motion.div
          ...
          className="relative w-full max-w-2xl rounded-3xl p-8 xl:p-10 border-2 shadow-2xl overflow-hidden text-center space-y-6"
          style={{
            backgroundColor: '#070b16',
            borderColor: celebration.winningTeamColor || '#f59e0b',
            boxShadow: `0 0 80px ${celebration.winningTeamColor || '#f59e0b'}35`,
          }}
        >
          <button
          ...
          <div className="flex items-center justify-center gap-2 text-xs font-mono font-bold tracking-widest text-cyan-400 uppercase">
            <img src="/robocell-logo.png" alt="RoboCell" className="w-5 h-5 object-contain inline-block" />
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-gradient-to-r from-cyan-400 via-teal-300 to-amber-300 text-black font-black text-sm uppercase tracking-widest shadow-xl shadow-cyan-500/40"
          >
          ...
          <div className="relative w-36 h-36 mx-auto">
            <div className="w-full h-full rounded-3xl overflow-hidden border-2 border-white/20 shadow-2xl">
              <img
            ...
            {celebration.winningTeamLogo && (
              <motion.div
                ...
                className="absolute -bottom-3 -right-3 w-14 h-14 rounded-2xl overflow-hidden border-2 border-white shadow-2xl bg-black"
              >
                <img
          ...
          <div className="space-y-1">
            <h2 className="text-2xl xl:text-3xl font-black text-white uppercase tracking-tight">
          ...
          <motion.div
            ...
            className="p-4 rounded-2xl bg-black/60 border border-white/15 inline-block space-y-0.5 px-8"
          >
